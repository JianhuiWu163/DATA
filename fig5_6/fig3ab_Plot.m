...
SakaiData = xlsread('SakaiAlgorithm_26.xlsx');
for i=1:n
...
text(8,41,2.2,'\downarrow','Color','b','FontName','Times New Roman','FontSize',8);
text(1,47,0,'\alpha-agent','Color','b','FontName','Times New Roman','FontSize',6,'rotation',40);

text(60,21,2,'\uparrow','Color','b','FontName','Times New Roman','FontSize',8,'rotation',30);
text(50,16.5,0,'Obstacle','Color','b','FontName','Times New Roman','FontSize',6);

text(75,73.5,2.1,'\uparrow','Color','b','FontName','Times New Roman','FontSize',8);
text(70,65,0,'\gamma-agent','Color','b','FontName','Times New Roman','FontSize',6);

text(29,22,2,'1','FontName','Times New Roman','FontSize',5);
text(29,48,2,'2','FontName','Times New Roman','FontSize',5);
text(29,74,2,'3','FontName','Times New Roman','FontSize',5);
text(59.5,34,2,'4','FontName','Times New Roman','FontSize',5);
text(59.5,60,2,'5','FontName','Times New Roman','FontSize',5);

%画线段
plot3(oyk(1,1),oyk(2,1),2,'.','color',[0/255,102/255,51/255]);
plot3(oyk(1,4),oyk(2,4),2,'.','color',[0/255,102/255,51/255]);
plot3([oyk(1,1),oyk(1,4)], [oyk(2,1), oyk(2,4)],[2,2],'b');
% text(45,23,2,'d_1_4','FontSize',5);

plot3(oyk(1,2),oyk(2,2),2,'.','color',[0/255,102/255,51/255]);
plot3(oyk(1,4),oyk(2,4),2,'.','color',[0/255,102/255,51/255]);
plot3([oyk(1,2),oyk(1,4)], [oyk(2,2), oyk(2,4)],[2,2],'b');
% text(40,36,2,'d_2_4','FontSize',5);

plot3(oyk(1,2),oyk(2,2),2,'.','color',[0/255,102/255,51/255]);
plot3(oyk(1,5),oyk(2,5),2,'.','color',[0/255,102/255,51/255]);
plot3([oyk(1,2),oyk(1,5)], [oyk(2,2),oyk(2,5)],[2,2],'b');
% text(45,50,2,'d_2_5','FontSize',5);

plot3(oyk(1,3),oyk(2,3),2,'.','color',[0/255,102/255,51/255]);
plot3(oyk(1,5),oyk(2,5),2,'.','color',[0/255,102/255,51/255]);
plot3([oyk(1,3),oyk(1,5)],[oyk(2,3),oyk(2,5)],[2,2],'b');
% text(45,73.5,4,'d_3_5','FontSize',5);
...
img =gcf;  %获取当前画图的句柄
% print(img, '-dpng', '-r600', './SakaiAlgorithm_26.png')
print(img, '-depsc', '-r600', './fig3a.eps');
%*************************************************************************************************%

Data_10agents = xlsread('ProposedAlgorithm_26.xlsx');
for i=1:n
...
% text(7,43.5,0,'\downarrow','Color','b','FontName','Times New Roman','FontSize',14);
% text(4,57,0,'\alpha-agent','Color','b','FontName','Times New Roman','FontSize',8);
% 
...
img =gcf;  %获取当前画图的句柄
% print(img, '-dpng', '-r600', './ProposedAlgorithm_26.png')
print(img, '-depsc', '-r600', './fig3b.eps');
